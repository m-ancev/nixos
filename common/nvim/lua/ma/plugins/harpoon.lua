return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>j", function() harpoon:list():select(1) end, { desc = "Jump to buffer 1"})
    vim.keymap.set("n", "<leader>k", function() harpoon:list():select(2) end, { desc = "Jump to buffer 2"})
    vim.keymap.set("n", "<leader>l", function() harpoon:list():select(3) end, { desc = "Jump to buffer 3"})
    vim.keymap.set("n", "<leader>;", function() harpoon:list():select(4) end, { desc = "Jump to buffer 4"})
